...
checkpoint = torch.load('/home/desktop/Downloads/DWFormer-main/download/WavLM-Large.pt')#Pretrained model checkpoint path.
...
#IEMOCAP:
for i in range(1,6):
    csv = r'/home/desktop/Downloads/DWFormer-main/Feature_Extractor/iemocap_data/data'# csv path. 
    inputdir = r'/home/desktop/Downloads/DWFormer-main/download/IEMOCAP_full_release/IEMOCAP_full_release/Session'# data path.
    outputdir = r'/home/desktop/Downloads/DWFormer-main/download/IEMOCAP_full_release/Feature/WavLM/Session' #feature path.
