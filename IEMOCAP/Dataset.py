...
os.mkdir(out_path)
for i in range(1,6):
    csvname1 = r'/home/desktop/Downloads/DWFormer-main/Feature_Extractor/iemocap_data/train'+ str(i) + '.csv'
    data_path = r'/home/desktop/Downloads/DWFormer-main/download/IEMOCAP_full_release/Feature/WavLM/'#place where saves the WavLM features
    mode = r'train' + str(i)
    ...
    mode = r'valid' + str(i)
    os.mkdir(out_path+mode)
    csvname2 = r'/home/desktop/Downloads/DWFormer-main/Feature_Extractor/iemocap_data/valid' + str(i) + '.csv'
