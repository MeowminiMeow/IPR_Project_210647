...
for i in range(1,6):
    ...
    out_path = r'/home/desktop/Downloads/DWFormer-main/new_database_wavlm_mask_324/'
    ...
    for epoch in range(EPOCH):
        print("print epoch ,for session id:- ",epoch," ",i)
        model.train()
        loss_tr = 0.0
        ...
        List = [i,epoch,"train",loss_tr,wa_tr,ua_tr,str(end_time-start_time)]
        with open('/home/desktop/Downloads/DWFormer-main/download/result.xlsx.csv', 'a') as f_object:
    ...
    # #---------------------------------------------------develop-----------------------------------------
        ...
        print('所耗时长:  ',str(end_time-start_time),'s')
        List = [i,epoch,"valid",loss_de,wa_de,ua_de,str(end_time-start_time)]
        with open('/home/desktop/Downloads/DWFormer-main/download/result.xlsx.csv', 'a') as f_object:
